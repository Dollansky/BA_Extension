...
/* harmony export */ });
/* unused harmony exports serverUrl, checkIfModeActive, sendMessageToEveryTab, openModeSelectInCurrentTab, updateIconTimer, calcIconTimer, setIcon, checkIfParticipantIdIsSet, onInstalledDo */
  ...
  var Modal = function (_Component3) {
    ...
    _createClass(Modal, [{
      ...
      value: function open($trigger) {
        ...
        // TODO Changed stuff here fyi
        this.$overlay[0].style.zIndex = 2141483300 + Modal._modalsOpen * 2;
        this.el.style.zIndex = 2141483300 + Modal._modalsOpen * 2 + 1;
...
function getReminderInstance() {
    return materialize.Modal.getInstance(getShadowWrapper().shadowRoot.getElementById('reminderModal'));
}
function getModalInstance() {
    return materialize.Modal.getInstance(getShadowWrapper().shadowRoot.getElementById('modal1'));
}
function openReminder(goal) {
    ...
    var reminderInstance = materialize.Modal.getInstance(shadowWrapper.shadowRoot.getElementById('reminderModal'));
...
function setUpAutoComplete() {
    var autocompleteInstance = materialize.Autocomplete.init(getShadowWrapper().shadowRoot.querySelectorAll('.autocomplete'));
...
function initializeModals() {
    materialize.Modal.init(getShadowRoot().getElementById('modal1'), {
        dismissible: false,
        onCloseEnd: function () {
            enableShortcuts();
        }
    });
    materialize.Modal.init(getShadowRoot().getElementById('reminderModal'), {
        dismissible: false,
        onCloseEnd: function () {
            setReason();
            unCheckRadioButtons();
